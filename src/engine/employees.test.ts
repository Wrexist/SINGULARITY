...
describe("employees — roster transitions", () => {
  it("assign sets the product; invalid product benches; fire removes", () => {
    ...
    s = { ...s, products: { ...s.products, active: [{ id: "prod-1", name: "X", type: "general", version: 1, quality: 1, priceMult: 1, marketingPerSec: 0, mau: 0, paid: 0, buzzSec: 0, upgrade: null, features: [] }] } };
