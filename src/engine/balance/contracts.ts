...
export const contracts = {
  ...
  sponsor: {
    ...
    sponsors: [
      ...
      "The a16z-Adjacent Momentum Fund",
      "A YC-Flavored Demo Day Slot",
      "The Hard Fork Podcast Bump",
      "The Anthropos Interpretability Bounty",
      "A Sovereign Wealth 'Innovation' Grant",
      "The Nvidiaesque Developer Prize",
      "The Product Hunt #1 Challenge",
      "An EU Horizon-ish Framework Grant",
      "The Stanford-Adjacent Eval Bake-Off",
