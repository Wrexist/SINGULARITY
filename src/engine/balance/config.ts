...
export const balance = {
  ...
  run: {
    ...
    minCompute: 10,
    durationSec: 5,
    // Tightened payout ratios (difficulty pass): runs return less per unit of
    // compute invested, so scaling the operation matters more than spamming runs.
    dataPerCompute: 0.28,
  ...
  upgrades: [
    {
      ...
      cost: { resource: "money", base: 15, growth: 1.18 },
      max: Infinity,
    ...
    },
    {
      ...
      cost: { resource: "money", base: 220, growth: 1.19 },
      max: Infinity,
    ...
    },
    {
      ...
      cost: { resource: "money", base: 3500, growth: 1.20 },
      max: Infinity,
    ...
    },
    {
      ...
      cost: { resource: "money", base: 600, growth: 1.55 },
      max: 25,
    ...
    },
    {
      ...
      cost: { resource: "money", base: 120, growth: 1.48 },
      max: 25,
    ...
    },
    {
      ...
      cost: { resource: "money", base: 150, growth: 1.48 },
      max: 25,
